    ...
    private void initiateMapPSL() throws MAPException {
        ...
        */
        try {
            ...
            String lmsiIdStr = "09876543";
            byte[] lmsid = lmsiIdStr.getBytes();
...
*/
            ...
            String areaIdStr = "102132";
            byte[] areaId = areaIdStr.getBytes();
...
*/
            ...
            byte[] lmsid = new BigInteger("0a010203", 16).toByteArray();
            LMSI lmsi = new LMSIImpl(lmsid);
            ...
            byte[] addLocationEstimate = new BigInteger("0000000002", 16).toByteArray();
